...
/**
 * Contains all pertinent instance variables and methods pertaining to a student's information 
 * and their site privileges. 
 * @author Ross Jaeger
 *
 */
public class Student extends User {
    ...
    public Student(String firstName, String lastName, boolean isGuest, int rating, String studentid, ArrayList<Listing> favoritesListings, boolean isUSCStudent) {
